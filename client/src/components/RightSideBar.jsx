...
const RightSideBar = () => {
  ...
  return (
    <div
      className={`bg-[#8185B2]/10 w-full text-white p-6 relative overflow-y-auto ${
      ...
      <div className="flex flex-col gap-4 text-sm text-white/90">
        <div className="text-center">
          ...
          <p className="text-base text-white/60">
            Upload your project as a ZIP file or paste a GitHub repo link below.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-col items-center ">
          <button
            ...
            className="h-10 w-30 bg-white/10 rounded-full"
          >
            Continue
          </button>
        </div>
